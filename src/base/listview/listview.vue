<template>
   <scroll class="listView" :data='data' ref="listview" @scroll="scroll" :probe-type="probeType" :listen-scroll="listenScroll">
      <ul>
...
export default {
   ...
   methods:{
      ...
      _scrollTo(index){
         ...
         console.log(index)
         this.$refs.listview.scrollToElement(this.$refs.listGroup[index], 0)//起最终作用
   ...
   watch:{
      ...
      diff(newVal){
         ...
         this.fixedTop = fixedTop//减少dom操作的频度
